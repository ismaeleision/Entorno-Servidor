      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav me-auto mb-2 mb-md-0">
            ...
            <li class="nav-item">
              <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#nuevo">
                Nuevo
              </button>
            </li>
          </ul>
        ...
        <div class="col-lg-3 mt-3">
          ...
          <div class="row">
            <form action='controlador.php' method='post'>
              ...
              <input type="submit" value="Cambiar" name="calendario">
            </form>
          </div>
        </div>
          ...
          <table class="table table-sm">
            ...
            <tbody>
              ...
              foreach ($tareas as $linea) {
                if (strtotime($linea[2]) < time()) {
                  echo "<tr style='background-color: red;'>";
                } else {
                  echo "<tr>";
                }
                echo "<th scope='row'>" . $linea[0] . "</th>";
                echo "<td>" . $linea[1] . "</td>";
                echo "<td>" . $linea[2] . "</td>";
                echo "<td>" . $linea[3] . "</td>";
              ?>
                <td><a href="controlador.php?accion=eliminar&id=<?= $linea[0] ?>">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Añadir Tareas</h5>
